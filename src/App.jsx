    ...
    <div className="flex flex-col h-screen bg-[#0a1014] text-white overflow-hidden font-sans">
      ...
      <main className="flex-1 overflow-hidden relative">
        ...
        {activeTab === 'reels' && (
          <div className="h-full flex items-center justify-center bg-black">
              <p className="text-gray-500 font-bold tracking-widest uppercase text-xs">TriNetra Reels Active</p>
          </div>
        )}
      </main>
      ...
      <nav className="absolute bottom-0 w-full bg-[#111827]/90 backdrop-blur-md border-t border-cyan-500/20 flex justify-around py-2 pb-6 z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
          ...
          <div className="relative -top-6">
            <button onClick={() => setActiveTab('ai')} className="bg-cyan-500 p-4 rounded-full shadow-[0_0_20px_rgba(6,182,212,0.5)] border-4 border-[#0a1014] active:scale-90 transition-transform">
